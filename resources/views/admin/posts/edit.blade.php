...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            ...
            <h4 class="theme-cl pull-right">Editar post</h4>
        </div>
    </div>
    <!-- Title & Breadcrumbs-->
...
@include('admin.includes.errors')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card">
                <!-- form start -->
               <form action="{{ route('post.update',['id' => $post->id]) }}" method="post" enctype="multipart/form-data" data-toggle="validator" class="padd-20">
                    ...
                    <div class="row mrg-0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $post->title }}" name="title" type="text" class="form-control" id="inputName" placeholder="Titulo" required>
                            </div>
                        </div>
                   ...
                   <div class="row mrg-0">
                       <div class="col-sm-12">
                           <div class="form-group">
                               ...
                               <textarea name="contenido" id="contenido" cols="30" rows="10" class="form-control">
                                   {{ $post->contenido }}
                               </textarea>
                           </div>
                       </div>
